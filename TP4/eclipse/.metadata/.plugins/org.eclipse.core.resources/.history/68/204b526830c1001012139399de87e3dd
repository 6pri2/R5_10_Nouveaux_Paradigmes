...
public class FenetreCoureur extends JFrame {
	...
	public FenetreCoureur() {
		...
		buttonVoir.addActionListener(e -> afficherInformationsCoureur(textFieldNom, textFieldPrenom, comboBoxAnneeNaissance, comboBoxAnneePrem, textAreaCoureur));
	}
	...
	private void afficherInformationsCoureur(JTextField nomField, JTextField prenomField, JComboBox anneeNaissanceBox, JComboBox anneePremBox, JTextArea textArea) {
	        ...
	        String message = nomFormatte + ' '+ prenomFormatte + ' '+ anneeNaissance +' '+anneePrem+'\n';
