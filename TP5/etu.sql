...
DROP TABLE CDI_MESSAGE CASCADE CONSTRAINTS;
DROP TABLE CDI_MAGASIN CASCADE CONSTRAINTS;
DROP TABLE CDI_POIMESSAGE CASCADE CONSTRAINTS;
DROP TABLE CDI_POIDS CASCADE CONSTRAINTS;
DROP TABLE CDI_ARTICLE CASCADE CONSTRAINTS;
DROP TABLE CDI_LIV_MESSAGE CASCADE CONSTRAINTS;
DROP TABLE CDI_LIGCDE CASCADE CONSTRAINTS;
DROP TABLE CDI_LIGLIV CASCADE CONSTRAINTS;

DROP TABLE CDI_ANCIEN_FOURNISSEUR CASCADE CONSTRAINTS;
...
(
    CL_NUMERO CHAR(8)  ,
    CL_NOM VARCHAR2(32),
    CL_PRENOM NVARCHAR2(32),
    CL_LOCALITE VARCHAR2(32),
    CL_PAYS VARCHAR2(32),
    CL_CA NUMBER(10,2),
    CL_TYPE VARCHAR2(32)  
);
...
(
    POM_MESSAGE_124 VARCHAR2(60)  ,
    POM_DATE_JOUR DATE  ,
    POM_TOTAL_LU NUMBER(3),
    POM_MESSAGE_3 VARCHAR2(60),
    POM_LOGIN VARCHAR2(32)  
);

CREATE TABLE CDI_POIDS
(
    POI_CODE NUMBER(1)  ,
    POI_LIBELLE VARCHAR2(10),
    POI_MIN NUMBER(4),
    POI_MAX NUMBER(4)  
);
...
(
    ...
    CL_NUMERO CHAR(8)  ,
    AR_NUMERO CHAR(8)  ,
    LV_MESSAGE VARCHAR2(5)  ,
    LV_LOGIN VARCHAR2(32)  
);
...
(
    ...
    CO_NUMERO CHAR(8)  ,
    DATE_LIV DATE,
    LIC_QTCMDEE NUMBER(4),
    LIC_QTLIVREE NUMBER(4),
    LIC_PU NUMBER(10,2)  
);
